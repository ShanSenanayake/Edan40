...
-- Putting it all together:
 ...
 jingleBasic   = jingle :=: autoComp Basic (G, Major) progression
 jingleCalypso = jingle :=: autoComp Calypso (G, Major) progression
 jingleBoogie  = jingle :=: autoComp Boogie (G, Major) progression